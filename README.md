...
Заполни значения (особенно `SECRET_KEY`, данные БД и email).

> **Важно:** для Docker оставь `POSTGRES_HOST=db` и `CELERY_BROKER_URL=redis://redis:6379/0`
...
Поднимет 5 контейнеров: PostgreSQL, Redis, Django, Celery worker, Celery beat.
...
Задеплоено на Railway: **https://libraryapi-production-ce3f.up.railway.app**

- Swagger UI: https://libraryapi-production-ce3f.up.railway.app/api/docs/
